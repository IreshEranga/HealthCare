export default [
    ...
    },
    {
      ...
      excersises : [
        ...
        {
          id:"91",
          image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5Mqic81gPJad28oKUWxaVywYWJXba8e7TLA&s",
    ...
    },
    {
      ...
      excersises:[
        ...
        {
          id:"71",
          image:"https://cdn.shopify.com/s/files/1/0449/8453/3153/files/Bench_Dips.gif?v=1722411995",
          name:"TRICEP DIPS",
          sets:10,
        },
        {
          id:"72",
          image:"https://program.rapidloss.com.au/wp-content/uploads/diamond-push-up.gif",
          name:"DIAMOND_PUSHUP",
          sets:10,
        },
        {
